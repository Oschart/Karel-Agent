...
a2c_agent = ActorCritic(a2c_policy, env, load_pretrained=True, max_episodes=100000, early_stop=7, variant_name='full_data') 
sac_agent = SoftActorCritic(sac_policy, env, load_pretrained=False, max_episodes=100000, early_stop=7, variant_name='full_data')
